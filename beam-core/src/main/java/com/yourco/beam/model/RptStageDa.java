 ...
 * {@code SELECT stage_da_json_tx FROM RptStageDa WHERE map_id = X} subqueries.
 ...
 *   stage_da_json_tx  STRING  NOT NULL,   -- row JSON (copied from DaRec.row_da_json_tx)
